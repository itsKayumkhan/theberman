    ...
    return (
        <div className="font-sans text-gray-900 bg-white min-h-screen">
            <SEOHead
                ...
                ogDescription={!isSpanish && !isEngland && !isFrance && !isPortugal ? 'See real BER certificate prices by property size and county. Compare quotes from SEAI-registered assessors and get the best price nationwide.' : isEngland ? 'EPC Certificate Pricing | Affordable Domestic, Commercial Costs' : undefined}
