...
const NAV_ITEMS: NavItem[] = [
    { id: 'basic-info', label: 'Basic Details', icon: Building2 },
    { id: 'visuals', label: 'Catalogue Media', icon: ImageIcon },
        ...
        <DashboardLayout
            ...
            extraSidebarItems={
                <Link
                    ...
                    target="_blank"
                    className="flex items-center gap-3 px-4 py-2 text-xs font-bold text-white/40 hover:text-[#9ACD32] transition-all"
                >
                    <div className="w-2 h-2 rounded-full bg-[#9ACD32]"></div>
                    View Public Page
                </Link>
            }
        >
