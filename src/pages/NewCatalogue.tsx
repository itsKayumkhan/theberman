...
const NewCatalogue = () => {
    ...
    const t = {
        ...
        berAssessors: isSpanish ? 'Certificadores Energéticos' : isEngland ? 'EPC Assessors' : isFrance ? 'Diagnostiqueurs DPE' : isPortugal ? 'Peritos Qualificados' : 'BER Assessors',
        ...
        assessorsSub: isSpanish ? 'Encuentra Certificadores Energéticos Acreditados en tu Zona Hoy' : isEngland ? 'EPC Assessors Across England' : isFrance ? 'Trouvez des Diagnostiqueurs Certifiés près de chez vous' : isPortugal ? 'Encontre Peritos Qualificados na sua Zona' : 'Find Certified BER Assessors in Your Local Area Today',
