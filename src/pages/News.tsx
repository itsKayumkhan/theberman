...
const NewsPage = () => {
    ...
    const { content: cms, loading: cmsLoading } = usePageContent('news');
    ...
    const tr = isSpanish ? {
        ...
        seoTitle: 'Actualités',
        seoDesc: 'Restez informé des nouvelles énergétiques, subventions et mises à jour du secteur du DPE.',
        loading: 'Chargement des actualités...',
        comingSoonH: 'Bientôt Disponible',
        comingSoonP: 'Nous préparons les dernières actualités sur les subventions énergétiques et la durabilité. Revenez bientôt.',
        returnHome: "Retour à l'Accueil",
        heading: 'Actualités et Mises à Jour',
        subheading: 'Les dernières nouvelles de DPE France sur l\'énergie, les subventions et la communauté',
        noArticles: 'Aucun article dans cette catégorie.',
        viewAllNews: 'Voir Toutes les Actualités',
        activeOffersH: 'Offres de Rénovation Actives',
        activeOffersP: 'Consultez les dernières subventions et offres.',
        viewOffers: 'Voir les Offres',
        newsletterH: 'Restez Informé',
        newsletterP: 'Abonnez-vous pour recevoir les actualités, subventions énergétiques et guides techniques.',
        emailPlaceholder: 'ADRESSE E-MAIL',
        sending: 'ENVOI EN COURS...',
        subscribe: "S'abonner",
        toastSuccess: 'Inscription confirmée.',
        toastError: 'Vérifiez votre connexion ou votre email.',
        locale: 'fr-FR' as const,
    } : isPortugal ? {
        seoTitle: 'Notícias',
        seoDesc: 'Mantenha-se atualizado sobre novidades energéticas, subsídios e atualizações do setor.',
        loading: 'A carregar notícias...',
        comingSoonH: 'Em Breve',
        comingSoonP: 'Estamos a preparar as últimas novidades sobre subsídios energéticos e sustentabilidade. Volte em breve.',
        returnHome: 'Voltar ao Início',
        heading: 'Notícias e Atualizações',
        subheading: 'As últimas notícias sobre energia, subsídios e comunidade',
        noArticles: 'Nenhum artigo nesta categoria.',
        viewAllNews: 'Ver Todas as Notícias',
        activeOffersH: 'Ofertas de Reabilitação Ativas',
        activeOffersP: 'Consulte os últimos subsídios e ofertas.',
        viewOffers: 'Ver Ofertas',
        newsletterH: 'Mantenha-se Atualizado',
        newsletterP: 'Subscreva para receber notícias, subsídios energéticos e guias técnicos.',
