                    ...
                    {activeTab === 'info' && (
                        <div className="space-y-5">
                            ...
                            <div className="pt-4 border-t border-gray-100">
                                <div className="flex items-center gap-2 mb-3"><MapPin size={14} className="text-orange-500" /><span className="text-xs font-bold text-gray-700">Preferred Locations</span></div>
