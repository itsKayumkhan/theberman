        ...
        <div style="padding: 40px 30px;">
            ...
            <div style="text-align: center; margin: 40px 0;">
                <a href="${dashboardUrl}" style="background-color: #007F00; color: #ffffff !important; padding: 18px 40px; text-decoration: none; border-radius: 6px; font-weight: bold; font-size: 18px; display: inline-block; box-shadow: 0 4px 12px rgba(0,127,0,0.2);">
                    ${isSpanish ? 'Revisar Detalles del Presupuesto' : isPortuguese ? 'Rever Detalhes do Orçamento' : isFrench ? 'Consulter les Détails du Devis' : 'Review Quote Details'}
                </a>
            </div>

            <p style="font-size: 15px; color: #555; margin-bottom: 25px;">
                ${isSpanish ? 'Puedes confirmar tu reserva al instante aceptando el presupuesto online. Un pequeño depósito asegura tu plaza en la agenda del certificador.' : isPortuguese ? 'Pode confirmar a sua reserva instantaneamente aceitando o orçamento online. Um pequeno depósito garante o seu lugar na agenda do perito certificador.' : isFrench ? 'Vous pouvez confirmer votre réservation instantanément en acceptant le devis en ligne. Un petit dépôt garantit votre place dans l\'agenda du diagnostiqueur.' : "You can instantly confirm your booking by accepting the quote online. A small deposit secures your spot in the assessor's schedule."}
            </p>

            <div style="font-size: 13px; color: #666; line-height: 1.5; border-top: 1px solid #eee; padding-top: 25px; font-style: italic;">
                <strong>${isSpanish ? 'Garantía de Tranquilidad:' : isPortuguese ? 'Garantia de Confiança:' : isFrench ? 'Garantie Sérénité :' : 'Peace of Mind Guarantee:'}</strong> ${isSpanish ? 'Ofrecemos una garantía de devolución del 100%. Si necesitas cancelar por cualquier motivo antes de la visita, te reembolsaremos el depósito íntegro.' : isPortuguese ? 'Oferecemos uma garantia de reembolso de 100%. Se precisar de cancelar por qualquer motivo antes da visita, o depósito será reembolsado na íntegra.' : isFrench ? 'Nous offrons une garantie de remboursement de 100 %. Si vous devez annuler pour quelque raison que ce soit avant la visite, votre dépôt sera intégralement remboursé.' : 'We offer a 100% money-back guarantee. If you need to cancel for any reason before the site visit, your deposit will be refunded in full.'}
            </div>
        </div>
