    ...
    if (status === 'scheduled') {
        ...
        message = isSpanish
            ...
            : isPortuguese
                ...
                : isFrench
                    ? `Excellentes nouvelles ! La visite pour votre DPE à <strong>${details.town}</strong> a été programmée pour le <strong>${details.inspectionDate}</strong> par <strong>${details.contractorName}</strong>.`
        ...
        title = isSpanish ? "Visita Reprogramada" : isPortuguese ? "Visita Reagendada" : isFrench ? "Visite Reprogrammée" : `${inspectionName.charAt(0).toUpperCase() + inspectionName.slice(1)} Rescheduled`;
        message = isSpanish
            ...
            : isPortuguese
                ...
                : isFrench
                    ? `Veuillez noter que la visite pour votre DPE à <strong>${details.town}</strong> a été reprogrammée au <strong>${details.inspectionDate}</strong>.`
        ...
        title = isSpanish ? "Trabajo Completado" : isPortuguese ? "Trabalho Concluído" : isFrench ? "Mission Terminée" : "Job Completed";
        message = isSpanish
            ...
            : isPortuguese
                ...
                : isFrench
                    ? `Votre DPE pour la propriété à <strong>${details.town}</strong> est maintenant prêt. Vous pouvez le consulter et le télécharger via le lien ci-dessous.`
        ...
        buttonText = isSpanish ? "Ver Certificado" : isPortuguese ? "Ver Certificado" : isFrench ? "Voir le Certificat" : "View Certificate";
