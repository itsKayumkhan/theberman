export const generateCredentialsHtml = (fullName: string, email: string, password: string, loginUrl: string, tenant: string = 'ireland', displayName: string = 'The Berman', websiteUrl: string = 'https://theberman.eu') => {
    ...
    <body>
        <div class="container">
            <div class="header">
                <h1>Bienvenue sur ${brandName}</h1>
                <p>Inscription ${roleName}</p>
            </div>
            <div class="content">
                ...
                <div class="credentials-box">
                    ...
                    <table style="width:100%; border-collapse:collapse;">
                        <tr>
                            <td style="padding:8px 0; font-weight:bold; color:#555; font-size:14px; width:110px;">E-mail :</td>
                            <td style="padding:8px 0;"><span class="credential-value">${email}</span></td>
                        </tr>
                        <tr>
                            <td style="padding:8px 0; font-weight:bold; color:#555; font-size:14px;">Mot de passe :</td>
                            <td style="padding:8px 0;"><span class="credential-value">${password}</span></td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="steps-box">
                    ...
                    <ol>
                        <li><strong>Connectez-vous</strong> avec les identifiants ci-dessus</li>
                        <li><strong>Complétez votre inscription</strong> en remplissant vos informations de diagnostiqueur</li>
                        <li>Commencez à recevoir des missions de DPE !</li>
                    </ol>
                </div>
            ...
            <div class="footer">
                <p>&copy; ${new Date().getFullYear()} ${brandName}. Tous droits réservés.</p>
                <div class="footer-links">
                    <a href="${websiteUrl}">Visiter le Site</a>
                </div>
            </div>
        </div>
    </body>
